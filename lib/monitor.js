...
[마케팅 키워드 작성 규칙]
- "responseKeywords"(추천 대응 마케팅 키워드): 경쟁사의 현재 프로모션에 맞대응할 키워드. 짧은 단어/구 4~6개.
- "proactiveKeywords"(선제적 마케팅 키워드): 경쟁사보다 앞서 선제적으로 펼칠 만한 키워드. 짧은 단어/구 4~6개.
...
반드시 아래 JSON 형식으로만 응답하세요. 마크다운이나 코드블록 없이 순수 JSON만:
{
  ...
  "responseKeywords": ["대응 키워드"],
  "proactiveKeywords": ["선제 키워드"],
  "urgency": "high",
