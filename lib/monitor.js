...
- "points"는 원장님께 말하듯 친근한 어조로 작성. 문장 끝은 "~해요", "~해보세요", "~하는 게 좋아요" 형태. 딱딱한 개조식('~함/~필요')이나 격식체('~했습니다/~합니다')는 쓰지 마세요. 각 항목 1줄, 2~4개.
  예) "우리 학원 합격 사례를 적극 발굴해서 홍보해보세요", "무료체험 도입을 검토해보는 게 좋아요"
...
- weeklyHighlights(이번 주 핵심): 이번 수집에서 가장 중요한 변화·이슈를 정확히 3개. 신규/종료 프로모션, 경쟁사의 공격적 움직임, 시급한 대응 포인트 위주. 각 1문장(개조식). 경영진이 3줄만 봐도 이번 주 상황을 파악하도록.
- responseKeywords(추천 대응): 경쟁사 움직임에 맞대응할 종합 마케팅 키워드 5~6개. 각 키워드마다 실행 예시 **핵심 3개**.
- proactiveKeywords(선제적): 경쟁사보다 앞서 펼칠 종합 키워드 5~6개. 각 키워드마다 실행 예시 **핵심 3개**.
- responseKeywords·proactiveKeywords의 각 예시는 반드시 {"text": "...", "by": "본사" 또는 "가맹점"} 형태로 실행 주체를 분류.
  ...
  · 문체는 친근하고 부드러운 구어체(격식체 '~습니다'·개조식 금지). by="본사"이면 본사가 지원하는 어투 — "~지원하고 있어요", "~도와드려요", "~은 본사로 문의해요" 형태. by="가맹점"이면 지점에 권하는 어투 — "~해보세요", "~하는 게 좋아요", "~해보는 건 어때요?" 형태.
...
{
  "weeklyHighlights": ["이번 주 핵심 변화 1", "핵심 2", "핵심 3"],
  "comparisonSummary": "자사 대비 경쟁사 전반 비교 2~3문장",
  "competitorBriefs": [{"name": "경쟁사명", "point": "핵심 마케팅 특징·위협 한 줄(개조식)"}],
  "responseKeywords": [{"keyword": "키워드", "examples": [{"text": "개조식 예시", "by": "본사"}, {"text": "개조식 예시", "by": "가맹점"}]}],
...
module.exports = { runMonitoring, loadData, loadHistory, generateReport, archiveReport, callGemini, DATA_DIR };
